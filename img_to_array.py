...
#TODO: Try without this and see what happens
...
with open(f'sprites.h', 'rt') as file:
    lines = file.readlines()

addition = ["{\"" + img_name + "\", {" + str(img_width) + ", " + str(img_height) + ", "  + str(buffer_hex) + "} },\n"]


lines = lines[:-1] + addition + [lines[-1]]


with open(f'sprites.h', 'wt') as file:
